...
في روبي، هناك اصطلاحات تسمية خاصة للدوال تجعل الكود أكثر وضوحاً. في هذا الدرس، سنتعلم عن نوعين مهمين من الدوال: دوال البانج (!) ودوال الاستعلام (?).
...
4. **استخدم دوال الاستعلام** مع `if` و `unless` لكتابة كود واضح
