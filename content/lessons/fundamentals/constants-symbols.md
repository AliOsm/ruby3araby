...
1. **قيم ثابتة رياضياًّ:** مثل π (باي) أو سرعة الضوء
...
> **نصيحة:** تعامل مع الثوابت كقيم لا يجب تغييرها أبداً، حتى لو سمحت روبي بذلك تقنياًّ.
...
```ruby
# الرموز تُستخدم داخلياًّ في روبي للدوال
