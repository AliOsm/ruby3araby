...
في روبي، إنشاء المتغيرات بسيط جداً. لا تحتاج لتحديد نوع البيانات - روبي تكتشفه تلقائياً.
...
هذه القيم مهمة جداً في الشروط والقرارات البرمجية.
...
|-------|------------------|-------|-----------|
| نص | String | `"مرحباً"`, `'hello'` | تخزين النصوص |
| رقم صحيح | Integer | `42`, `-10`, `1_000` | الأعداد الكاملة |
| رقم عشري | Float | `3.14`, `-0.5` | الأرقام بكسور |
...
> **تلميح:** تذكر أن روبي تكتشف نوع البيانات تلقائياً - فقط اكتب القيم مباشرة!
