...
when الحالة_الأولى
  # الكود إذا تحققت الحالة الأولى
when الحالة_الثانية
  # الكود إذا تحققت الحالة الثانية
else
  # الكود إذا لم تتحقق أي حالة
end
```
...
يمكن استخدام `then` لكتابة الكود في سطر واحد:
...
> **تذكّر:** `case/when` تجعل الكود أنظف وأسهل للقراءة عندما تقارن قيمة واحدة بعدة احتمالات!
