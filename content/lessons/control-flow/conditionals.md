...
```ruby
if الشرط
  # الشيفرة التي ستُنفَّذ إذا كان الشرط صحيحاً
end
```
...
```ruby
if الشرط
  # تُنفَّذ إذا كان الشرط صحيحاً
else
  # تُنفَّذ إذا كان الشرط خاطئاً
end
```
...
```ruby
if الشرط_الأول
  # تُنفَّذ إذا كان الشرط الأول صحيحاً
elsif الشرط_الثاني
  # تُنفَّذ إذا كان الشرط الثاني صحيحاً
elsif الشرط_الثالث
  # تُنفَّذ إذا كان الشرط الثالث صحيحاً
else
  # تُنفَّذ إذا كانت جميع الشروط خاطئة
end
```
