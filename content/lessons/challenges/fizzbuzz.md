...
15 % 3  # => 0  (يقبل القسمة على 3)
15 % 5  # => 0  (يقبل القسمة على 5)
15 % 7  # => 1  (لا يقبل القسمة على 7)
```
...
# ❌ ترتيب خاطئ
if number % 3 == 0
  puts "Fizz"      # الرقم 15 سيطبع Fizz فقط!
elsif number % 5 == 0
  puts "Buzz"
elsif number % 3 == 0 && number % 5 == 0
  puts "FizzBuzz"  # لن نصل لهذا الشرط أبداً!
end

# ✅ ترتيب صحيح
if number % 3 == 0 && number % 5 == 0
  puts "FizzBuzz"  # فحص الحالة الخاصة أولاً
elsif number % 3 == 0
  puts "Fizz"
elsif number % 5 == 0
  puts "Buzz"
